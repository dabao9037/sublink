...
REPO_URL="${SUBLINK_REPO_URL:-https://github.com/1828006573/sublink.git}"
RAW_BASE="${SUBLINK_RAW_BASE:-https://raw.githubusercontent.com/1828006573/sublink/main}"
...
show_menu(){
  while true; do
    ...
    echo -e "${C_GREEN}${C_BOLD}└──────────────────────────────────┘${C_RESET}"
    echo "  1. 安装 / 更新 SubLink"
    echo "  2. 修改访问端口"
    echo "  3. 修改后台账号密码"
    echo "  4. 绑定域名 / 配置 HTTPS"
    echo "  5. 卸载 SubLink"
    echo "  6. 查看运行信息"
    echo "  0. 退出"
    echo
